# Adaboost Multiclass Classifier in Scikit-Learn with Shapley Explanations
## Project Description
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Adaboost multiclass classifier model implemented using **Scikit-Learn** library.
